...
[MainWindow.xaml.cs L48-63](https://github.com/vt241syas-collab/lab_1_KPZ.git/MainWindow.xaml.cs#L48-L63)

2. KISS (Keep It Simple, Stupid)
Намагання зробити код максимально простим. Клас `Food` містить лише необхідні координати без зайвої складності.
[Food.cs](https://github.com/vt241syas-collab/lab_1_KPZ.git/Food.cs)
...
[GameEngine.cs L13-14](https://github.com/vt241syas-collab/lab_1_KPZ.git/GameEngine.cs#L13-L14)